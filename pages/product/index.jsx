    ...
    <div className='flex h-screen items-center gap-20 py-20 flex-wrap'>
      ...
      <div className='md:flex-1 md:text-start text-center'>
        ...
        <p className='text-sm my-4 md:pr-24'>
            ...
            fugit corporis ex laboriosam tenetur at ad aspernatur eius numquam molestiae.
        </p>
        <div>
            ...
            <div className='flex items-center gap-x-20 md:justify-start justify-center'>
                <div className='relative w-8 h-8'>
                    ...
                    <span className='absolute top-0 -right-9 text-sm bg-primary rounded-full px-[5px] font-medium'>Small</span>
                </div>
                <div className='relative w-12 h-12'>
                    <Image src="/images/size.png" alt='' layout='fill'/>
                    <span className='absolute top-0 -right-9 text-sm bg-primary rounded-full px-[5px] font-medium'>Medium</span>
                </div>
                <div className='relative w-16 h-16'>
                    <Image src="/images/size.png" alt='' layout='fill'/>
                    <span className='absolute top-0 -right-6 text-sm bg-primary rounded-full px-[5px] font-medium'>Large</span>
                </div>
            </div>
        </div>
