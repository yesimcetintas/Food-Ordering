        ...
        <div className="flex md:justify-between justify-center text-center flex-wrap md:gap-y-0 gap-y-6 ">
          <div className="md:flex-1">
            ...
            <div className="flex flex-col gap-y-2 mt-3">
              <a href={footer?.location} target="_blank" rel="noreferrer" className="hover:text-primary transition-all">
                <i className="fa fa-map-marker"></i>
                <span className="inline-block ml-2">Location</span>
              </a>
              <a href={`tel:${footer?.phoneNumber}`} className="hover:text-primary transition-all">
                <i className="fa fa-phone"></i>
                <span className="inline-block ml-2">Call +90 {footer?.phoneNumber}</span>
              </a>
              <a href={`mailto:${footer?.email}`} className="hover:text-primary transition-all">
